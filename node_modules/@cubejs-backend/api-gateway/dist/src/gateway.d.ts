...
declare class ApiGateway {
    ...
    meta({ context, res, includeCompilerId }: {
        context: RequestContext;
     ...
     */
    protected getNormalizedQueries(query: Record<string, any> | Record<string, any>[], context: RequestContext, persistent?: boolean): Promise<[QueryType, NormalizedQuery[]]>;
    ...
    private parseMemberExpressionsInQueries;
    ...
    protected checkAuthWrapper(checkAuthFn: CheckAuthFn, req: Request, res: ExpressResponse, next: any): Promise<void>;
