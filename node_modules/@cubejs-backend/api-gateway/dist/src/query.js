...
const memberExpression = joi_1.default.object().keys({
...
const querySchema = joi_1.default.object().keys({
    ...
    measures: joi_1.default.array().items(joi_1.default.alternatives(id, memberExpression)),
    dimensions: joi_1.default.array().items(joi_1.default.alternatives(dimensionWithTime, memberExpression)),
    ...
    segments: joi_1.default.array().items(joi_1.default.alternatives(id, memberExpression)),
