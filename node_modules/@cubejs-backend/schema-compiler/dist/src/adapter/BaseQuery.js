...
class BaseQuery {
    ...
    buildSqlAndParams(exportAnnotatedSql) {
        ...
        return this.compilers.compiler.withQuery(this, () => this.cacheValue(['buildSqlAndParams', exportAnnotatedSql], () => this.paramAllocator.buildSqlAndParams(this.buildParamAnnotatedSql(), exportAnnotatedSql), { cache: this.queryCache }));
    }
    /**
    ...
    keyDimensions(primaryKeyDimensions) {
        return ramda_1.default.uniqBy((d) => d.dimension, this.dimensionsForSelect()
    ...
    primaryKeyNames(cubeName) {
        ...
        if (!primaryKeys || !primaryKeys.length) {
            throw new UserError_1.UserError(`One or more Primary key is required for '${cubeName}`);
        }
