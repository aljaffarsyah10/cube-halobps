...
class PreAggregations {
    ...
    static canUsePreAggregationForTransformedQueryFn(transformedQuery, refs) {
         ...
         * @returns {boolean}
         */
        const canUseFn = transformedQuery.leafMeasureAdditive &&
    ...
    static flattenAllMembers(query) {
        return ramda_1.default.flatten(query.measures
    ...
    measuresRenderedReference(preAggregationForQuery) {
        return ramda_1.default.pipe(ramda_1.default.map(path => {
            ...
            return [
                path,
                this.query.aggregateOnGroupedColumn(measure.measureDefinition(), measure.aliasName(), !this.query.safeEvaluateSymbolContext().overTimeSeriesAggregate, path) || `sum(${measure.aliasName()})`,
            ];
