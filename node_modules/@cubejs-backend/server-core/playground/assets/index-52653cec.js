...
`+F(e),t!=null&&t.useMarkdownDescription&&(c.markdownDescription=e.description+`
`+F(e,!0))):(c.description=F(e),t!=null&&t.useMarkdownDescription&&(c.markdownDescription=F(e,!0))),Object.keys(l).forEach(u=>{const o=l[u],{required:d,definition:f,definitions:v}=V(o.type,t),{definition:p}=V(o,t);c.properties[u]=Object.assign(Object.assign({},f),p);const T=F(o.type);if(c.properties[u].description=o.description?o.description+`
`+T:T,t!=null&&t.useMarkdownDescription){const g=F(o.type,!0);c.properties[u].markdownDescription=o.description?o.description+`
`+g:g}d&&c.required.push(u),v&&Object.keys(v).map(g=>{a[g]=v[g]})}),a[e.name]=c}return"description"in e&&!ae(e)&&e.description&&!r.description?(r.description=e.description+`
`+F(e),t!=null&&t.useMarkdownDescription&&(r.markdownDescription=e.description+`
`+F(e,!0))):(r.description=F(e),t!=null&&t.useMarkdownDescription&&(r.markdownDescription=F(e,!0))),{required:i,definition:r,definitions:a}}function bn(e,t){const n={$schema:"https://json-schema.org/draft/2020-12/schema",type:"object",properties:{},required:[]};return e&&Object.entries(e).forEach(([i,r])=>{var a;const{definition:l,required:c,definitions:u}=V(r,t);n.properties[i]=l,c&&((a=n.required)===null||a===void 0||a.push(i)),u&&(n.definitions=Object.assign(Object.assign({},n==null?void 0:n.definitions),u))}),n}function yn(e,t,n){const i=ge(e,n);let r;return Z(t,{enter(a){if(a.kind!=="Name"&&a.loc&&a.loc.start<=i&&i<=a.loc.end)r=a;else return!1},leave(a){if(a.loc&&a.loc.start<=i&&i<=a.loc.end)return!1}}),r}function ge(e,t){const n=e.split(`
`).slice(0,t.line);return t.character+n.map(i=>i.length+1).reduce((i,r)=>i+r,0)}const{INLINE_FRAGMENT:kn}=q;function Fn(e){let t;try{t=le(e)}catch(r){return null}const n=In(e);return{outlineTrees:Z(t,{leave(r){return n!==void 0&&r.kind in n?n[r.kind](r):null}})}}function In(e){const t=n=>({representativeName:n.name,startPosition:H(e,n.loc.start),endPosition:H(e,n.loc.end),kind:n.kind,children:n.selectionSet||n.fields||n.values||n.arguments||[]});return{Field:n=>{const i=n.alias?[m("plain",n.alias),m("plain",": ")]:[];return i.push(m("plain",n.name)),Object.assign({tokenizedText:i},t(n))},OperationDefinition:n=>Object.assign({tokenizedText:[m("keyword",n.operation),m("whitespace"," "),m("class-name",n.name)]},t(n)),Document:n=>n.definitions,SelectionSet:n=>Nn(n.selections,i=>i.kind===kn?i.selectionSet:i),Name:n=>n.value,FragmentDefinition:n=>Object.assign({tokenizedText:[m("keyword","fragment"),m("whitespace"," "),m("class-name",n.name)]},t(n)),InterfaceTypeDefinition:n=>Object.assign({tokenizedText:[m("keyword","interface"),m("whitespace"," "),m("class-name",n.name)]},t(n)),EnumTypeDefinition:n=>Object.assign({tokenizedText:[m("keyword","enum"),m("whitespace"," "),m("class-name",n.name)]},t(n)),EnumValueDefinition:n=>Object.assign({tokenizedText:[m("plain",n.name)]},t(n)),ObjectTypeDefinition:n=>Object.assign({tokenizedText:[m("keyword","type"),m("whitespace"," "),m("class-name",n.name)]},t(n)),InputObjectTypeDefinition:n=>Object.assign({tokenizedText:[m("keyword","input"),m("whitespace"," "),m("class-name",n.name)]},t(n)),FragmentSpread:n=>Object.assign({tokenizedText:[m("plain","..."),m("class-name",n.name)]},t(n)),InputValueDefinition:n=>Object.assign({tokenizedText:[m("plain",n.name)]},t(n)),FieldDefinition:n=>Object.assign({tokenizedText:[m("plain",n.name)]},t(n)),InlineFragment:n=>n.selectionSet}}function m(e,t){return{kind:e,value:t}}function Nn(e,t){const n=[];for(let i=0;i<e.length;i++){const r=t(e[i],i);Array.isArray(r)?n.push(...r):n.push(r)}return n}function On(e,t,n,i,r){const a=i||ie(t,n);if(!e||!a||!a.state)return"";const l=a.state,c=l.kind,u=l.step,o=re(e,a.state),d=Object.assign(Object.assign({},r),{schema:e});if(c==="Field"&&u===0&&o.fieldDef||c==="AliasedField"&&u===2&&o.fieldDef){const f=[];return C(f,d),_n(f,o,d),h(f,d),x(f,d,o.fieldDef),f.join("").trim()}else if(c==="Directive"&&u===1&&o.directiveDef){const f=[];return C(f,d),ve(f,o),h(f,d),x(f,d,o.directiveDef),f.join("").trim()}else if(c==="Argument"&&u===0&&o.argDef){const f=[];return C(f,d),An(f,o,d),h(f,d),x(f,d,o.argDef),f.join("").trim()}else if(c==="EnumValue"&&o.enumValue&&"description"in o.enumValue){const f=[];return C(f,d),Mn(f,o,d),h(f,d),x(f,d,o.enumValue),f.join("").trim()}else if(c==="NamedType"&&o.type&&"description"in o.type){const f=[];return C(f,d),j(f,o,d,o.type),h(f,d),x(f,d,o.type),f.join("").trim()}return""}function C(e,t){t.useMarkdown&&E(e,"```graphql\n")}function h(e,t){t.useMarkdown&&E(e,"\n```")}function _n(e,t,n){Ee(e,t,n),De(e,t,n,t.type)}function Ee(e,t,n){if(!t.fieldDef)return;const i=t.fieldDef.name;i.slice(0,2)!=="__"&&(j(e,t,n,t.parentType),E(e,".")),E(e,i)}function ve(e,t,n){if(!t.directiveDef)return;const i="@"+t.directiveDef.name;E(e,i)}function An(e,t,n){if(t.directiveDef?ve(e,t):t.fieldDef&&Ee(e,t,n),!t.argDef)return;const i=t.argDef.name;E(e,"("),E(e,i),De(e,t,n,t.inputType),E(e,")")}function De(e,t,n,i){E(e,": "),j(e,t,n,i)}function Mn(e,t,n){if(!t.enumValue)return;const i=t.enumValue.name;j(e,t,n,t.inputType),E(e,"."),E(e,i)}function j(e,t,n,i){i&&(i instanceof Le?(j(e,t,n,i.ofType),E(e,"!")):i instanceof oe?(E(e,"["),j(e,t,n,i.ofType),E(e,"]")):E(e,i.name))}function x(e,t,n){if(!n)return;const i=typeof n.description=="string"?n.description:null;i&&(E(e,`

`),E(e,i)),jn(e,t,n)}function jn(e,t,n){if(!n)return;const i=n.deprecationReason?n.deprecationReason:null;i&&(E(e,`

`),E(e,"Deprecated: "),E(e,i))}function E(e,t){e.push(t)}const Ln=Object.freeze(Object.defineProperty({__proto__:null,CharacterStream:K,get CompletionItemKind(){return Re},DIAGNOSTIC_SEVERITY:Ce,FileChangeTypeKind:he,LexRules:xe,ParseRules:Ve,Position:Pe,Range:we,RuleKinds:s,SEVERITY:Ue,SuggestionCommand:ne,canUseDirective:me,collectVariables:Ge,getASTNodeAtPosition:yn,getAutocompleteSuggestions:un,getDefinitionQueryResultForDefinitionNode:Be,getDefinitionQueryResultForFragmentSpread:Qe,getDefinitionQueryResultForNamedType:Ye,getDefinitionState:de,getDiagnostics:$e,getFieldDef:W,getFragmentDefinitions:Te,getFragmentDependencies:ze,getFragmentDependenciesForAST:Je,getHoverInformation:On,getOperationASTFacts:Ke,getOperationFacts:qe,getOutline:Fn,getQueryFacts:He,getRange:We,getTokenAtPosition:ie,getTypeInfo:re,getVariableCompletions:te,getVariablesJSONSchema:bn,isIgnored:Xe,list:Ze,offsetToPosition:H,onlineParser:ue,opt:en,p:nn,pointToOffset:ge,t:tn,validateQuery:rn,validateWithCustomRules:an},Symbol.toStringTag,{value:"Module"})),hn=be(Ln);export{hn as r};
