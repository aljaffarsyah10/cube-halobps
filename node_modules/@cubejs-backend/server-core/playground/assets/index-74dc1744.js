...
`)+`
`}function qi(e){if(!(e.description==null&&Qi(e))){var n=[],r=e.getQueryType();r&&n.push("  query: ".concat(r.name));var a=e.getMutationType();a&&n.push("  mutation: ".concat(a.name));var t=e.getSubscriptionType();return t&&n.push("  subscription: ".concat(t.name)),C({},e)+`schema {
`.concat(n.join(`
`),`
}`)}}function Qi(e){var n=e.getQueryType();if(n&&n.name!=="Query")return!1;var r=e.getMutationType();if(r&&r.name!=="Mutation")return!1;var a=e.getSubscriptionType();return!(a&&a.name!=="Subscription")}function Sr(e,n){if(he(e))return Bi(e,n);if(K(e))return Ki(e,n);if(z(e))return xi(e,n);if(J(e))return _i(e,n);if(X(e))return Yi(e,n);if(_(e))return Hi(e,n);q(0,"Unexpected type: "+S(e))}function Bi(e,n){return C(n,e)+"scalar ".concat(e.name)+zi(e)}function Pr(e){var n=e.getInterfaces();return n.length?" implements "+n.map(function(r){return r.name}).join(" & "):""}function Ki(e,n){return C(n,e)+"type ".concat(e.name)+Pr(e)+Mr(n,e)}function xi(e,n){return C(n,e)+"interface ".concat(e.name)+Pr(e)+Mr(n,e)}function _i(e,n){var r=e.getTypes(),a=r.length?" = "+r.join(" | "):"";return C(n,e)+"union "+e.name+a}function Yi(e,n){var r=e.getValues().map(function(a,t){return C(n,a,"  ",!t)+"  "+a.name+fn(a.deprecationReason)});return C(n,e)+"enum ".concat(e.name)+ln(r)}function Hi(e,n){var r=G(e.getFields()).map(function(a,t){return C(n,a,"  ",!t)+"  "+Je(a)});return C(n,e)+"input ".concat(e.name)+ln(r)}function Mr(e,n){var r=G(n.getFields()).map(function(a,t){return C(e,a,"  ",!t)+"  "+a.name+Lr(e,a.args,"  ")+": "+String(a.type)+fn(a.deprecationReason)});return ln(r)}function ln(e){return e.length!==0?` {
`+e.join(`
`)+`
}`:""}function Lr(e,n){var r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"";return n.length===0?"":n.every(function(a){return!a.description})?"("+n.map(Je).join(", ")+")":`(
`+n.map(function(a,t){return C(e,a,"  "+r,!t)+"  "+r+Je(a)}).join(`
`)+`
`+r+")"}function Je(e){var n=Ee(e.defaultValue,e.type),r=e.name+": "+String(e.type);return n&&(r+=" = ".concat(Z(n))),r+fn(e.deprecationReason)}function Wi(e,n){return C(n,e)+"directive @"+e.name+Lr(n,e.args)+(e.isRepeatable?" repeatable":"")+" on "+e.locations.join(" | ")}function fn(e){if(e==null)return"";var n=Ee(e,nn);return n&&e!==ur?" @deprecated(reason: "+Z(n)+")":" @deprecated"}function zi(e){if(e.specifiedByUrl==null)return"";var n=e.specifiedByUrl,r=Ee(n,nn);return r||q(0,"Unexpected null value returned from `astFromValue` for specifiedByUrl")," @specifiedBy(url: "+Z(r)+")"}function C(e,n){var r=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"",a=arguments.length>3&&arguments[3]!==void 0?arguments[3]:!0,t=n.description;if(t==null)return"";if((e==null?void 0:e.commentDescriptions)===!0)return Ji(t,r,a);var i=t.length>70,u=aa(t,"",i),c=r&&!a?`
`+r:r;return c+u.replace(/\n/g,`
`+r)+`
`}function Ji(e,n,r){var a=n&&!r?`
`:"",t=e.split(`
`).map(function(i){return n+(i!==""?"# "+i:"#")}).join(`
`);return a+t+`
`}function Xi(e){for(var n=[],r=0;r<e.length;r++){var a=e[r];n=n.concat(a.definitions)}return{kind:"Document",definitions:n}}function Zi(e){for(var n=[],r=Object.create(null),a=0,t=e.definitions;a<t.length;a++){var i=t[a];switch(i.kind){case w.OPERATION_DEFINITION:n.push(i);break;case w.FRAGMENT_DEFINITION:r[i.name.value]=Un(i.selectionSet);break}}for(var u=Object.create(null),c=function(o){for(var l=n[o],v=new Set,m=0,E=Un(l.selectionSet);m<E.length;m++){var g=E[m];Fr(v,r,g)}var R=l.name?l.name.value:"";u[R]={kind:w.DOCUMENT,definitions:e.definitions.filter(function(D){return D===l||D.kind===w.FRAGMENT_DEFINITION&&v.has(D.name.value)})}},s=0;s<n.length;s++)c(s);return u}function Fr(e,n,r){if(!e.has(r)){e.add(r);var a=n[r];if(a!==void 0)for(var t=0;t<a.length;t++){var i=a[t];Fr(e,n,i)}}}function Un(e){var n=[];return an(e,{FragmentSpread:function(a){n.push(a.name.value)}}),n}function $i(e){for(var n=ta(e)?e:new cr(e),r=n.body,a=new or(n),t="",i=!1;a.advance().kind!==se.EOF;){var u=a.token,c=u.kind,s=!ia(u.kind);i&&(s||u.kind===se.SPREAD)&&(t+=" ");var f=r.slice(u.start,u.end);c===se.BLOCK_STRING?t+=eu(f):t+=f,i=s}return t}function eu(e){var n=e.slice(3,-3),r=tr(n);ua(r)>0&&(r=`
`+r);var a=r[r.length-1],t=a==='"'&&r.slice(-4)!=='\\"""';return(t||a==="\\")&&(r+=`
`),'"""'+r+'"""'}function Gn(e,n){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);n&&(a=a.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,a)}return r}function Cn(e){for(var n=1;n<arguments.length;n++){var r=arguments[n]!=null?arguments[n]:{};n%2?Gn(Object(r),!0).forEach(function(a){nu(e,a,r[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):Gn(Object(r)).forEach(function(a){Object.defineProperty(e,a,Object.getOwnPropertyDescriptor(r,a))})}return e}function nu(e,n,r){return n in e?Object.defineProperty(e,n,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[n]=r,e}var M=Object.freeze({TYPE_REMOVED:"TYPE_REMOVED",TYPE_CHANGED_KIND:"TYPE_CHANGED_KIND",TYPE_REMOVED_FROM_UNION:"TYPE_REMOVED_FROM_UNION",VALUE_REMOVED_FROM_ENUM:"VALUE_REMOVED_FROM_ENUM",REQUIRED_INPUT_FIELD_ADDED:"REQUIRED_INPUT_FIELD_ADDED",IMPLEMENTED_INTERFACE_REMOVED:"IMPLEMENTED_INTERFACE_REMOVED",FIELD_REMOVED:"FIELD_REMOVED",FIELD_CHANGED_KIND:"FIELD_CHANGED_KIND",REQUIRED_ARG_ADDED:"REQUIRED_ARG_ADDED",ARG_REMOVED:"ARG_REMOVED",ARG_CHANGED_KIND:"ARG_CHANGED_KIND",DIRECTIVE_REMOVED:"DIRECTIVE_REMOVED",DIRECTIVE_ARG_REMOVED:"DIRECTIVE_ARG_REMOVED",REQUIRED_DIRECTIVE_ARG_ADDED:"REQUIRED_DIRECTIVE_ARG_ADDED",DIRECTIVE_REPEATABLE_REMOVED:"DIRECTIVE_REPEATABLE_REMOVED",DIRECTIVE_LOCATION_REMOVED:"DIRECTIVE_LOCATION_REMOVED"}),Q=Object.freeze({VALUE_ADDED_TO_ENUM:"VALUE_ADDED_TO_ENUM",TYPE_ADDED_TO_UNION:"TYPE_ADDED_TO_UNION",OPTIONAL_INPUT_FIELD_ADDED:"OPTIONAL_INPUT_FIELD_ADDED",OPTIONAL_ARG_ADDED:"OPTIONAL_ARG_ADDED",IMPLEMENTED_INTERFACE_ADDED:"IMPLEMENTED_INTERFACE_ADDED",ARG_DEFAULT_VALUE_CHANGE:"ARG_DEFAULT_VALUE_CHANGE"});function ru(e,n){var r=jr(e,n).filter(function(a){return a.type in M});return r}function au(e,n){var r=jr(e,n).filter(function(a){return a.type in Q});return r}function jr(e,n){return[].concat(iu(e,n),tu(e,n))}function tu(e,n){for(var r=[],a=x(e.getDirectives(),n.getDirectives()),t=0,i=a.removed;t<i.length;t++){var u=i[t];r.push({type:M.DIRECTIVE_REMOVED,description:"".concat(u.name," was removed.")})}for(var c=0,s=a.persisted;c<s.length;c++){for(var f=s[c],o=f[0],l=f[1],v=x(o.args,l.args),m=0,E=v.added;m<E.length;m++){var g=E[m];tn(g)&&r.push({type:M.REQUIRED_DIRECTIVE_ARG_ADDED,description:"A required arg ".concat(g.name," on directive ").concat(o.name," was added.")})}for(var R=0,D=v.removed;R<D.length;R++){var N=D[R];r.push({type:M.DIRECTIVE_ARG_REMOVED,description:"".concat(N.name," was removed from ").concat(o.name,".")})}o.isRepeatable&&!l.isRepeatable&&r.push({type:M.DIRECTIVE_REPEATABLE_REMOVED,description:"Repeatable flag was removed from ".concat(o.name,".")});for(var U=0,k=o.locations;U<k.length;U++){var $=k[U];l.locations.indexOf($)===-1&&r.push({type:M.DIRECTIVE_LOCATION_REMOVED,description:"".concat($," was removed from ").concat(o.name,".")})}}return r}function iu(e,n){for(var r=[],a=x(G(e.getTypeMap()),G(n.getTypeMap())),t=0,i=a.removed;t<i.length;t++){var u=i[t];r.push({type:M.TYPE_REMOVED,description:Ce(u)?"Standard scalar ".concat(u.name," was removed because it is not referenced anymore."):"".concat(u.name," was removed.")})}for(var c=0,s=a.persisted;c<s.length;c++){var f=s[c],o=f[0],l=f[1];X(o)&&X(l)?r.push.apply(r,ou(o,l)):J(o)&&J(l)?r.push.apply(r,cu(o,l)):_(o)&&_(l)?r.push.apply(r,uu(o,l)):K(o)&&K(l)||z(o)&&z(l)?r.push.apply(r,qn(o,l).concat(kn(o,l))):o.constructor!==l.constructor&&r.push({type:M.TYPE_CHANGED_KIND,description:"".concat(o.name," changed from ")+"".concat(Qn(o)," to ").concat(Qn(l),".")})}return r}function uu(e,n){for(var r=[],a=x(G(e.getFields()),G(n.getFields())),t=0,i=a.added;t<i.length;t++){var u=i[t];sr(u)?r.push({type:M.REQUIRED_INPUT_FIELD_ADDED,description:"A required field ".concat(u.name," on input type ").concat(e.name," was added.")}):r.push({type:Q.OPTIONAL_INPUT_FIELD_ADDED,description:"An optional field ".concat(u.name," on input type ").concat(e.name," was added.")})}for(var c=0,s=a.removed;c<s.length;c++){var f=s[c];r.push({type:M.FIELD_REMOVED,description:"".concat(e.name,".").concat(f.name," was removed.")})}for(var o=0,l=a.persisted;o<l.length;o++){var v=l[o],m=v[0],E=v[1],g=le(m.type,E.type);g||r.push({type:M.FIELD_CHANGED_KIND,description:"".concat(e.name,".").concat(m.name," changed type from ")+"".concat(String(m.type)," to ").concat(String(E.type),".")})}return r}function cu(e,n){for(var r=[],a=x(e.getTypes(),n.getTypes()),t=0,i=a.added;t<i.length;t++){var u=i[t];r.push({type:Q.TYPE_ADDED_TO_UNION,description:"".concat(u.name," was added to union type ").concat(e.name,".")})}for(var c=0,s=a.removed;c<s.length;c++){var f=s[c];r.push({type:M.TYPE_REMOVED_FROM_UNION,description:"".concat(f.name," was removed from union type ").concat(e.name,".")})}return r}function ou(e,n){for(var r=[],a=x(e.getValues(),n.getValues()),t=0,i=a.added;t<i.length;t++){var u=i[t];r.push({type:Q.VALUE_ADDED_TO_ENUM,description:"".concat(u.name," was added to enum type ").concat(e.name,".")})}for(var c=0,s=a.removed;c<s.length;c++){var f=s[c];r.push({type:M.VALUE_REMOVED_FROM_ENUM,description:"".concat(f.name," was removed from enum type ").concat(e.name,".")})}return r}function kn(e,n){for(var r=[],a=x(e.getInterfaces(),n.getInterfaces()),t=0,i=a.added;t<i.length;t++){var u=i[t];r.push({type:Q.IMPLEMENTED_INTERFACE_ADDED,description:"".concat(u.name," added to interfaces implemented by ").concat(e.name,".")})}for(var c=0,s=a.removed;c<s.length;c++){var f=s[c];r.push({type:M.IMPLEMENTED_INTERFACE_REMOVED,description:"".concat(e.name," no longer implements interface ").concat(f.name,".")})}return r}function qn(e,n){for(var r=[],a=x(G(e.getFields()),G(n.getFields())),t=0,i=a.removed;t<i.length;t++){var u=i[t];r.push({type:M.FIELD_REMOVED,description:"".concat(e.name,".").concat(u.name," was removed.")})}for(var c=0,s=a.persisted;c<s.length;c++){var f=s[c],o=f[0],l=f[1];r.push.apply(r,su(e,o,l));var v=oe(o.type,l.type);v||r.push({type:M.FIELD_CHANGED_KIND,description:"".concat(e.name,".").concat(o.name," changed type from ")+"".concat(String(o.type)," to ").concat(String(l.type),".")})}return r}function su(e,n,r){for(var a=[],t=x(n.args,r.args),i=0,u=t.removed;i<u.length;i++){var c=u[i];a.push({type:M.ARG_REMOVED,description:"".concat(e.name,".").concat(n.name," arg ").concat(c.name," was removed.")})}for(var s=0,f=t.persisted;s<f.length;s++){var o=f[s],l=o[0],v=o[1],m=le(l.type,v.type);if(!m)a.push({type:M.ARG_CHANGED_KIND,description:"".concat(e.name,".").concat(n.name," arg ").concat(l.name," has changed type from ")+"".concat(String(l.type)," to ").concat(String(v.type),".")});else if(l.defaultValue!==void 0)if(v.defaultValue===void 0)a.push({type:Q.ARG_DEFAULT_VALUE_CHANGE,description:"".concat(e.name,".").concat(n.name," arg ").concat(l.name," defaultValue was removed.")});else{var E=Bn(l.defaultValue,l.type),g=Bn(v.defaultValue,v.type);E!==g&&a.push({type:Q.ARG_DEFAULT_VALUE_CHANGE,description:"".concat(e.name,".").concat(n.name," arg ").concat(l.name," has changed defaultValue from ").concat(E," to ").concat(g,".")})}}for(var R=0,D=t.added;R<D.length;R++){var N=D[R];tn(N)?a.push({type:M.REQUIRED_ARG_ADDED,description:"A required arg ".concat(N.name," on ").concat(e.name,".").concat(n.name," was added.")}):a.push({type:Q.OPTIONAL_ARG_ADDED,description:"An optional arg ".concat(N.name," on ").concat(e.name,".").concat(n.name," was added.")})}return a}function oe(e,n){return B(e)?B(n)&&oe(e.ofType,n.ofType)||L(n)&&oe(e,n.ofType):L(e)?L(n)&&oe(e.ofType,n.ofType):je(n)&&e.name===n.name||L(n)&&oe(e,n.ofType)}function le(e,n){return B(e)?B(n)&&le(e.ofType,n.ofType):L(e)?L(n)&&le(e.ofType,n.ofType)||!L(n)&&le(e.ofType,n):je(n)&&e.name===n.name}function Qn(e){if(he(e))return"a Scalar type";if(K(e))return"an Object type";if(z(e))return"an Interface type";if(J(e))return"a Union type";if(X(e))return"an Enum type";if(_(e))return"an Input type";q(0,"Unexpected type: "+S(e))}function Bn(e,n){var r=Ee(e,n);r!=null||q(0);var a=an(r,{ObjectValue:function(i){var u=[].concat(i.fields);return u.sort(function(c,s){return ir(c.name.value,s.name.value)}),Cn(Cn({},i),{},{fields:u})}});return Z(a)}function x(e,n){for(var r=[],a=[],t=[],i=Re(e,function(v){var m=v.name;return m}),u=Re(n,function(v){var m=v.name;return m}),c=0;c<e.length;c++){var s=e[c],f=u[s.name];f===void 0?a.push(s):t.push([s,f])}for(var o=0;o<n.length;o++){var l=n[o];i[l.name]===void 0&&r.push(l)}return{added:r,persisted:t,removed:a}}function lu(e,n){return en(e,n,[lr])}const fu=Object.freeze(Object.defineProperty({__proto__:null,BREAK:ca,BreakingChangeType:M,DEFAULT_DEPRECATION_REASON:ur,DangerousChangeType:Q,DirectiveLocation:oa,ExecutableDefinitionsRule:sa,FieldsOnCorrectTypeRule:la,FragmentsOnCompositeTypesRule:fa,GraphQLBoolean:va,GraphQLDeprecatedDirective:rr,GraphQLDirective:Ie,GraphQLEnumType:Ve,GraphQLError:O,GraphQLFloat:pa,GraphQLID:da,GraphQLIncludeDirective:Hn,GraphQLInputObjectType:Te,GraphQLInt:ma,GraphQLInterfaceType:Ne,GraphQLList:Se,GraphQLNonNull:Pe,GraphQLObjectType:Ae,GraphQLScalarType:Ye,GraphQLSchema:Ge,GraphQLSkipDirective:Yn,GraphQLSpecifiedByDirective:ar,GraphQLString:nn,GraphQLUnionType:we,Kind:w,KnownArgumentNamesRule:ha,KnownDirectivesRule:Ea,KnownFragmentNamesRule:ba,KnownTypeNamesRule:ga,Lexer:or,Location:Da,LoneAnonymousOperationRule:ya,LoneSchemaDefinitionRule:Oa,NoDeprecatedCustomRule:lr,NoFragmentCyclesRule:Ra,NoSchemaIntrospectionCustomRule:Ti,NoUndefinedVariablesRule:Ia,NoUnusedFragmentsRule:Ta,NoUnusedVariablesRule:Va,OverlappingFieldsCanBeMergedRule:Aa,PossibleFragmentSpreadsRule:Na,PossibleTypeExtensionsRule:wa,ProvidedRequiredArgumentsRule:Sa,ScalarLeafsRule:Pa,SchemaMetaFieldDef:Be,SingleFieldSubscriptionsRule:Ma,Source:cr,Token:La,TokenKind:se,TypeInfo:Fa,TypeKind:ja,TypeMetaFieldDef:Ke,TypeNameMetaFieldDef:xe,UniqueArgumentNamesRule:Ua,UniqueDirectiveNamesRule:Ga,UniqueDirectivesPerLocationRule:Ca,UniqueEnumValueNamesRule:ka,UniqueFieldDefinitionNamesRule:qa,UniqueFragmentNamesRule:Qa,UniqueInputFieldNamesRule:Ba,UniqueOperationNamesRule:Ka,UniqueOperationTypesRule:xa,UniqueTypeNamesRule:_a,UniqueVariableNamesRule:Ya,ValidationContext:Ha,ValuesOfCorrectTypeRule:Wa,VariablesAreInputTypesRule:za,VariablesInAllowedPositionRule:Ja,__Directive:Xa,__DirectiveLocation:Za,__EnumValue:$a,__Field:et,__InputValue:nt,__Schema:rt,__Type:at,__TypeKind:tt,assertAbstractType:it,assertCompositeType:ut,assertDirective:ct,assertEnumType:ot,assertInputObjectType:st,assertInputType:lt,assertInterfaceType:ft,assertLeafType:vt,assertListType:pt,assertNamedType:dt,assertNonNullType:mt,assertNullableType:ht,assertObjectType:Et,assertOutputType:bt,assertScalarType:gt,assertSchema:Xn,assertType:Dt,assertUnionType:yt,assertValidName:Ot,assertValidSchema:_n,assertWrappingType:Rt,astFromValue:Ee,buildASTSchema:Nr,buildClientSchema:It,buildSchema:Fi,coerceInputValue:vr,concatAST:Xi,createSourceEventStream:Vr,defaultFieldResolver:Or,defaultTypeResolver:yr,doTypesOverlap:Tt,execute:on,executeSync:dr,extendSchema:Mi,findBreakingChanges:ru,findDangerousChanges:au,findDeprecatedUsages:lu,formatError:Vi,getDescription:H,getDirectiveValues:pe,getIntrospectionQuery:Jn,getLocation:Vt,getNamedType:zn,getNullableType:At,getOperationAST:Ai,getOperationRootType:un,getVisitFn:Nt,graphql:gi,graphqlSync:Di,introspectionFromSchema:Si,introspectionTypes:nr,isAbstractType:$e,isCompositeType:wt,isDefinitionNode:St,isDirective:Pt,isEnumType:X,isEqualType:Mt,isExecutableDefinitionNode:Lt,isInputObjectType:_,isInputType:xn,isInterfaceType:z,isIntrospectionType:ne,isLeafType:Xe,isListType:B,isNamedType:je,isNonNullType:L,isNullableType:Ft,isObjectType:K,isOutputType:jt,isRequiredArgument:tn,isRequiredInputField:sr,isScalarType:he,isSchema:Ut,isSelectionNode:Gt,isSpecifiedDirective:rn,isSpecifiedScalarType:Ce,isType:Ct,isTypeDefinitionNode:Zn,isTypeExtensionNode:$n,isTypeNode:kt,isTypeSubTypeOf:qt,isTypeSystemDefinitionNode:Qt,isTypeSystemExtensionNode:Bt,isUnionType:J,isValidNameError:Kt,isValueNode:xt,isWrappingType:_t,lexicographicSortSchema:Ui,locatedError:W,parse:Ue,parseType:Yt,parseValue:Ht,print:Z,printError:Wt,printIntrospectionSchema:Ci,printLocation:zt,printSchema:Gi,printSourceLocation:Jt,printType:Sr,responsePathAsArray:F,separateOperations:Zi,specifiedDirectives:He,specifiedRules:Xt,specifiedScalarTypes:er,stripIgnoredCharacters:$i,subscribe:Ri,syntaxError:Zt,typeFromAST:Ze,validate:en,validateSchema:Wn,valueFromAST:fe,valueFromASTUntyped:$t,version:ai,versionInfo:ti,visit:an,visitInParallel:ei,visitWithTypeInfo:ni},Symbol.toStringTag,{value:"Module"})),du=ri(fu);export{du as r};
